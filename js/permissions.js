...
export const ACTION_CAPABILITY={
  ...
  'purchase-new':'purchaseWrite','purchase-import':'purchaseWrite','purchase-prompt':'purchaseWrite','products-export':'invoiceRead',
  'clients-export':'invoiceRead','stock-export':'stockAdjust','expense-new':'expenseWrite','price-mass':'priceWrite','route-new':'routeWrite',
