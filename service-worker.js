const CACHE='aw9-v1.0.2';
const ASSETS=['./','./index.html','./styles.css','./firebase-config.js','./js/store.js','./js/app.js','./js/iva-ui.js','./js/box-billing.js','./js/app-code-1.txt','./js/app-code-2.txt','./js/app-code-3.txt','./manifest.webmanifest','./icon.svg'];
